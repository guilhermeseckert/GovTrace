...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Search any politician, company, or person and instantly see their donations, contracts, lobbying, grants, international aid, and parliamentary votes across public federal datasets.' },
      { property: 'og:type', content: 'website' },
      { property: 'og:site_name', content: 'GovTrace' },
      { property: 'og:title', content: 'GovTrace — Follow the money in Canadian government' },
      { property: 'og:description', content: 'Search any politician, company, or person and instantly see their donations, contracts, lobbying, grants, international aid, and parliamentary votes across public federal datasets.' },
      { property: 'og:url', content: 'https://govtrace.ca' },
      { name: 'twitter:card', content: 'summary' },
      { name: 'twitter:title', content: 'GovTrace — Follow the money in Canadian government' },
      { name: 'twitter:description', content: 'Search any politician, company, or person and instantly see their donations, contracts, lobbying, grants, and parliamentary votes across public federal datasets.' },
    ],
    links: [
...
function RootComponent() {
  ...
  return (
    <html lang="en" className={theme} suppressHydrationWarning>
      <head>
        <HeadContent />
        <script defer src="https://umami.lab.guilhermeseckert.dev/script.js" data-website-id="bcaf207d-d2a6-427b-89cf-e5de60107c85"></script>
      </head>
